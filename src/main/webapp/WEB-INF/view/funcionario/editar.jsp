...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="box">
			<form:form method="post" servletRelativeAction="/funcionario/atualizar" modelAttribute="funcionario">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<a href="<c:url value='/funcionario/${funcionario.id }/excluir'/>" ><button type="button" class="btn btn-primary" id="delete"> Confirmar </button></a>
							</div>
						</div>
					</div>
				</div>
